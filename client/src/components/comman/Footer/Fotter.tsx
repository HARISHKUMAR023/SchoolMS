...
const Footer = () => {
    return (
      <div className="text-zinc-500 flex p-4 pb-1 fixed bottom-0 w-[85%] overflow-x-auto z-10 justify-between ">
          ...
          <p className="text-xs hover:text-black dark:hover:text-white cursor-pointer">Copyright &copy; 2023. All rights reserved.</p>
          <p className="text-xs hover:text-black dark:hover:text-white cursor-pointer">&reg; Harish Kumar & Co.</p>
